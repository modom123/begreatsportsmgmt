...
export default function Footer() {
  return (
    <footer className="bg-[#060a14] border-t border-gray-800 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="font-black text-white tracking-wide text-lg">
                BE<span className="text-amber-500">GREAT</span>
              </span>
            </Link>
            <p className="text-gray-500 text-sm leading-relaxed mb-6">
              Elite sports management representing world-class athletes across all major sports. We turn potential into legacy.
            </p>
            <div className="flex gap-3">
              ...
              <a
                href="#"
                aria-label="Twitter"
                className="w-9 h-9 bg-gray-800 hover:bg-amber-500/20 hover:text-amber-400 text-gray-400 rounded-lg flex items-center justify-center transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: '/media-kits#athletes', label: 'Our Athletes' },
                { href: '/media-kits#request', label: 'Contact Us' },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">
            &copy; {new Date().getFullYear()} BeGreat Sports Management. All rights reserved.
          </p>
          <div className="flex gap-5 text-sm">
            <a href="#" className="text-gray-600 hover:text-gray-400 transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-600 hover:text-gray-400 transition-colors">Terms of Use</a>
          </div>
        </div>
      </div>
    </footer>
